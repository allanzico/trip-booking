            ...
            <div class="flex flex-col w-full justify-center  margin-r-2">
              <div class="sticky top-0 rounded-xl w-full h-full">
                <ul class="flex sm:flex-col overflow-hidden content-center justify-center">
                  <li class="py-2">
                    <Link
                      className=" inline-flex items-center text-gray-600 hover:w-full hover:bg-orange-500 hover:text-white block px-3 py-2 rounded-sm text-base font-medium"
                      to="/dashboard/seller"
                    >
                      <RiSuitcase3Line className="sm:mx-2 text-2xl md:text-sm lg:text-sm " />{" "}
                  ...
                  {auth &&
                    ...
                    auth.user.stripe_seller.charges_enabled && (
                      <button
                        ...
                        className=" inline-flex  items-center bg-orange-500 text-white block px-3 py-2 rounded-sm text-base font-medium"
                      >
                        <MdOutlineSettings className="sm:mx-2 text-2xl md:text-sm lg:text-sm " />{" "}
                        <span class="hidden sm:inline">Stripe Payouts</span>
                      </button>
                    )}
                </ul>
              </div>
