...
export const resetPassword = async (password, resetToken) => {
  return await axios.post(`${process.env.REACT_APP_API}/reset-password/${resetToken}`, {password});
};

export const forgotPassword = async (email) => {
  return await axios.post(`${process.env.REACT_APP_API}/forgot-password`, {email});
};
