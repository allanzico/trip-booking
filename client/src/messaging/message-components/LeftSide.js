...
const LeftSide = () => {
  return (
    <>
      ...
      <div class="h-full hidden md:block transform transition-all duration-500 ease-in-out w-96 bg-slate-50 border-r flex flex-col">
        <div class="h-full">
          ...
          <div class="px-5 py-4   flex items-center bg-white cursor-pointer border-r-4 border-r-orange-500 border-t border-b">
            <img
